...
#define STRING_CONFIG_H_AUTHOR "(Petzed, Ender-3 Pro)" // Who made the changes.
...
// (Use MINTEMP for thermistor short/failure protection.) pzk
...
/*
pzk 80PLA 215 Plasty mladec 421.32 
*/

#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 421.32  }
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 24, 240 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
//pzk pozice sondy sonda oproti trysce
#define NOZZLE_TO_PROBE_OFFSET { 38, -3, -1 }
...
#define XY_PROBE_SPEED (200*60) //pzk bylo 200*60

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST HOMING_FEEDRATE_Z

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 5) //pzk 
...
#define Z_CLEARANCE_BETWEEN_PROBES  5 // pzk 8 >  Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     3 //  pzk 5 > 3 Z Clearance between multiple probes
...
//pzk deska bed
#define X_MIN_POS 2
#define Y_MIN_POS -4 // bylo 4
#define Z_MIN_POS 0
#define X_MAX_POS 239 //240
#define Y_MAX_POS 232 //227
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 195   // (°C) Only applies to E0 at this time  pzk
...
//pzk vypnout
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 5.0 // pzk bylo 5 (mm) Default fade height.
  #endif
  ...
  //#define PROBE_Y_FIRST
    ...
    // Default is to maintain the height of the nearest edge.  pzk
...
#define HOMING_FEEDRATE_Z  (20*60)  // As Per Ilya Tsaryuk who did testing with Bltouch clone and homing feedrate accuracy.
