...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_TIMEOUT_TO_STATUS 60000 //pzk vypnuto nebo ms 15000
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.05    // pzk bylo 0.22 to bylo moc!!! Unit: mm compression per 1mm/s extruder speed
